...
#define PHMAP_BTREE_BTREE_CONTAINER_H_
  ...
  #pragma warning(                                                                                 \
    disable : 4365) // conversion from 'int' to 'const unsigned __int64', signed/unsigned mismatch
...
namespace phmap {
  ...
  public:
    ...
    friend constexpr bool
    operator==(compare_internal::OnlyLiteralZero<>, strong_equality v) noexcept
    {
      return 0 == v.value_;
    }
    friend constexpr bool
  ...
  public:
    ...
    friend constexpr bool
    operator==(compare_internal::OnlyLiteralZero<>, partial_ordering v) noexcept
    {
  ...
  public:
    ...
    friend constexpr bool
    operator==(compare_internal::OnlyLiteralZero<>, strong_ordering v) noexcept
    {
      return 0 == v.value_;
    }
    friend constexpr bool
...
namespace phmap {
  ...
  namespace priv {
    ...
    struct common_params
    {
      ...
      using node_count_type = phmap::conditional_t<(kNodeSlotSpace / sizeof(slot_type) >
  ...
  #pragma GCC diagnostic pop
    ...
    private:
      ...
      size_type
      internal_verify(const node_type* node, const key_type* lo, const key_type* hi) const;
    ...
    template<typename... Args>
    inline void
    btree_node<P>::emplace_value(const size_type i, allocator_type* alloc, Args&&... args)
    {
      assert(i <= count());
    ...
    template<typename P>
    inline void
    btree_node<P>::remove_values_ignore_children(int i, size_type to_erase, allocator_type* alloc)
    {
                                                ...
                                                allocator_type* alloc)
    {
      ...
      if (right->count() >= to_move) {
        ...
        uninitialized_move_n(
          uninitialized_remaining, count() - uninitialized_remaining, right->count(), right, alloc);
        params_type::move(alloc,
    ...
    auto btree<P>::erase(iterator iter) -> iterator
    {
      ...
      if (!iter.node->leaf()) {
        ...
        params_type::move(mutable_allocator(),
    ...
    template<typename K>
    inline auto
    btree<P>::internal_locate_impl(const K& key, std::false_type /* IsCompareTo */) const
      -> SearchResult<iterator, false>
    {
    ...
    protected:
      ...
      using key_arg = typename KeyArg<
        IsTransparent<typename Tree::key_compare>::value>::template type<K, typename Tree::key_type>;
    ...
    public:
      ...
      {
        return this->tree_.insert_hint_unique(iterator(hint), params_type::key(x), std::move(x))
          .first;
      }
      ...
      {
        init_type v(std::forward<Args>(args)...);
        return this->tree_.insert_hint_unique(iterator(hint), params_type::key(v), std::move(v))
          .first;
      }
      ...
      iterator insert(const_iterator hint, node_type&& node)
      {
        ...
        std::pair<iterator, bool> res =
          this->tree_.insert_hint_unique(iterator(hint),
    ...
    public:
      ...
      {
        return this->tree_.insert_unique(k,
  ...
  class btree_map
    : public priv::btree_map_container<priv::btree<
        priv::map_params<Key, Value, Compare, Alloc, /*TargetNodeSize=*/256, /*Multi=*/false>>>
  {
  ...
  class btree_multimap
    : public priv::btree_multimap_container<priv::btree<
        priv::map_params<Key, Value, Compare, Alloc, /*TargetNodeSize=*/256, /*Multi=*/true>>>
  {
