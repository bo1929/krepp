...
namespace phmap {
  ...
  // ----------------------------------------------------------------------
    ...
    private:
      ...
      template<class Key>
      static auto
      GetReturnType(int) -> decltype(std::declval<std::hash<Key>>()(std::declval<Key const&>()));
      template<class Key>
...
namespace phmap {
  namespace priv {
    ...
    public:
      ...
      static auto
      apply(F&& f, Ts&&... ts) -> decltype(P::apply(std::forward<F>(f), std::forward<Ts>(ts)...))
      {
    ...
    struct Invoker
    {
      typedef typename std::conditional<
        ...
        typename std::conditional<
          ...
          MemFunAndPtr,
          typename std::conditional<DataMemAndRef::Accept<Args...>::value,
                                    DataMemAndRef,
...
namespace phmap {
  ...
  struct allocator_traits
  {
    ...
    using size_type =
      memory_internal::ExtractOrT<memory_internal::GetSizeType,
                                  Alloc,
    ...
    using propagate_on_container_swap = memory_internal::
      ExtractOrT<memory_internal::GetPropagateOnContainerSwap, Alloc, std::false_type>;
...
namespace phmap {
  ...
  namespace optional_internal {
    ...
    struct optional_hash_base<T,
                              decltype(std::hash<phmap::remove_const_t<T>>()(
  ...
  public:
    ...
    template<typename U = T,
             typename = typename std::enable_if<phmap::conjunction<
               phmap::negation<std::is_same<optional<T>, typename std::decay<U>::type>>,
               phmap::negation<phmap::conjunction<std::is_scalar<T>,
    ...
    template<typename U,
             typename = typename std::enable_if<phmap::conjunction<
               ...
               phmap::negation<
                 optional_internal::is_constructible_convertible_assignable_from_optional<T, U>>>::
                                                  value>::type>
    ...
    constexpr const T&& value() const&&
    { // NOLINT(build/c++11)
      return phmap::move(static_cast<bool>(*this)
                           ? reference()
                           : (optional_internal::throw_bad_optional_access(), reference()));
    }
    #ifdef _MSC_VER
  ...
  template<typename T,
           typename std::enable_if<std::is_move_constructible<T>::value, bool>::type = false>
...
namespace phmap {
  ...
  namespace span_internal {
    ...
    using HasData =
      std::is_convertible<phmap::decay_t<decltype(GetData(std::declval<C&>()))>*, T* const*>;
  ...
  namespace priv {
    ...
    namespace internal_layout {
      ...
      public:
        ...
        template<class Char>
        std::tuple<
          SliceType<CopyConst<Char, typename std::tuple_element<SizeSeq, ElementTypes>::type>>...>
        Slices(Char* p) const
        {
      ...
      using LayoutType =
        LayoutImpl<std::tuple<Ts...>,
                   phmap::make_index_sequence<NumSizes>,
